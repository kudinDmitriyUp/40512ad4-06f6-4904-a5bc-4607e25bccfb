...
export const metadata: Metadata = {
  title: "MediaPro - Creative Media Agency & Branding Solutions",
  description: "Award-winning creative media agency offering branding, social media, photography, 3D design, and corporate event services. Transform your brand vision into reality.",
  keywords: "creative agency, branding, social media marketing, photography, 3D design, packaging design, corporate events",
  metadataBase: new URL("https://mediapro.agency"),
  alternates: {
    canonical: "https://mediapro.agency"
  },
  openGraph: {
    title: "MediaPro - Creative Media Agency",
    description: "Transform your brand with our award-winning creative solutions",
    url: "https://mediapro.agency",
    siteName: "MediaPro",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32fyUI1AepMVfxIUkQhrdGSZ2DN/uploaded-1763994893048-mo301i3l.jpg",
        alt: "MediaPro Creative Agency Portfolio"
      }
    ]
  },
  twitter: {
    ...
    title: "MediaPro - Creative Media Agency",
    description: "Award-winning creative solutions for your brand",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32fyUI1AepMVfxIUkQhrdGSZ2DN/uploaded-1763994893048-mo301i3l.jpg"]
  },
  robots: {
    index: true,
    follow: true
